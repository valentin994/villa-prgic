...
function ApartmentCard({
  ...
  const summaryList = t("summary", { returnObjects: true }) as string[];
  const descList = t("desc", { returnObjects: true }) as string[];
  return (
    <div
      ref={ref}
        ...
        <div className="flex flex-col justify-between p-4 py-8 leading-normal w-full">
          <div className="flex flex-row justify-between">
            ...
            <div className="hidden md:flex md:flex-row">
              {[...Array(3 - index)].map((value: undefined, index: number) => (
          ...
          <p className="mb-4 text-blue-600">{descList[index]}</p>
