...
function Footer() {
  ...
  return (
    <div className="-mt-6 text-sm py-2 px-2">
        <div className="flex rounded-[40px] justify-between py-8 px-20 bg-blue-500 gap-8 text-gray-50 text-base font-thin">
            <div className="flex flex-col justify-center">
              <h1 className="text-3xl font-bold">Villa Prgic</h1>
            </div>
            <div className="flex flex-col justify-center">
            ...
            <ul className="flex text-sm justify-center gap-8">
                <li className="hover:underline"><NavLink to="/">IMPRESSUM</NavLink></li>
                <li className="hover:underline"><NavLink to="/">F.A.Q.</NavLink></li>
            </ul>
            </div>

            <ul className="justify-center gap-8">
                <li className="hover:text-gray-200"><NavLink to="/">HOME</NavLink></li>
                <li className="hover:text-gray-200"><NavLink to="/">APARTMENTS</NavLink></li>
                <li className="hover:text-gray-200"><NavLink to="/">REGION</NavLink></li>
                <li className="hover:text-gray-200"><NavLink to="/">CONTACT</NavLink></li>
            </ul>
        </div>
