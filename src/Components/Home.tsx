...
function Home() {
  ...
  return (
    <div className="text-text-col">
        <p ref={ref} className={`text-4xl font-thin text-center italic p-4 m-8 hidden md:max-[4200px]:block transform transition-all duration-300 ease-in-out ${inView ? "opacity-100" : "delay-300 opacity-20 translate-y-10"}`}>Lorem Ipsum ...</p>
