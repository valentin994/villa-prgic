        ...
        <nav className="border-gray-200 text-white rounded bg-secondary">
          <div className="flex flex-wrap items-center justify-between mx-auto w-full ">
            <a href="#" className="flex items-center p-4">
                <span className="self-center text-xl font-light whitespace-nowrap">Villa Prgic</span>
            </a>
            <button data-collapse-toggle="navbar-solid-bg" onClick={() => setIsMenuOpen(!isMenuOpen)} type="button" className="inline-flex items-center p-4 ml-3 text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200" aria-controls="navbar-solid-bg" aria-expanded="false">
            ...
            {
                isMenuOpen &&
            <div className={`w-full md:block md:w-auto bg-piction-blue text-white`} id="navbar-solid-bg">
