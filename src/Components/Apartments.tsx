...
function Apartments() {
  ...
  return (
    <div className="pt-24 flex flex-col justify-center min-h-screen bg-cover bg-no-repeat rounded-[40px] bg-[url(https://woop14abphufecql.public.blob.vercel-storage.com/apartments-FZ3rsKJMYR9dq9IkFJugsYMk1TilBf.jpg)] mx-2 my-2 mb-3">
